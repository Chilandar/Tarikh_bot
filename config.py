...
RESERVED_HOURS = [22]  # کاملاً متعلق به خودِ کاربره، ربات هرگز توش پست نمی‌ذاره
...
# ---------------------------------------------------------------------------
HISTORY_MESSAGES_PER_RUN = 10   # هر اجرا حداکثر این تعداد پیام "خوب و واجدشرایط" به صف اضافه می‌شه (دستور دستیِ /scan)
