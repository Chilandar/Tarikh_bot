...
CATEGORY_KEYWORDS = {
    CATEGORY_SOKHAN_BOZORGAN: [
        ...
        "فرمود", "حکمت", "پند", "گفته است", "می‌گفت", "میگفت", "توصیه می‌کرد",
        "جمله‌ی معروف", "نقل قول",
    ],
    CATEGORY_AKS_IRAN_QADIM: [
        "عکس قدیمی", "تهران قدیم", "دوران قاجار", "عکس تاریخی", "تصویری از",
        "عکس نادر", "آرشیو عکس", "عکس یادگاری", "عکس دیده‌نشده", "تصویر قدیمی",
        "عکس آرشیوی", "عکاسی از", "در این عکس", "این تصویر",
    ],
    CATEGORY_HEKAYAT: [
