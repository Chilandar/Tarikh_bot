...
مهم‌ترین قانون: سوال باید مثل یک سوالِ مستقلِ کوییز خونده بشه - انگار همینطوری
از حفظ درباره‌ی تاریخ می‌پرسی، نه از روی یک متنِ خاص. به همین خاطر، سوال
هرگز نباید به وجودِ متن/مقاله/منبع/روایت/داستانِ اشاره‌شده در بالا اشاره کنه.
هر شروعی شبیهِ «بر اساس متن»، «طبق روایت»، «بر اساس این داستان»، «طبق مقاله»،
«در این متن آمده که»، «با توجه به منبع» یا هر عبارتِ مشابهی که به وجودِ یک
متن/منبعِ مرجع اشاره کنه، *ممنوعه* - سوال باید مستقیماً و بدون هیچ مقدمه‌ای
با خودِ پرسش شروع بشه (مثلاً «کدام پادشاه...» یا «در چه سالی...»).
